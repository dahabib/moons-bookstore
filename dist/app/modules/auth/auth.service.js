...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isPasswordMached = function (givenPassword, savedPassword) {
    ...
    if (isUserExists.password &&
        !(yield isPasswordMached(password, isUserExists.password))) {
        throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, 'Incorrect password');
    }
    // generate access token
    const accessToken = jwtHelpers_1.jwtHelpers.generateToken({ role, userId }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    return {
        token: accessToken,
    };
});
